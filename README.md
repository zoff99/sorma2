...
You still need to add ```sqlite-jdbc-3.51.1.1.jar``` to your project to use it.<br>
<br><br>
...
```bash
java -classpath ".:sqlite-jdbc-3.51.1.1.jar:sorma2.jar" \
...
Use the `sorma_generated.jar` (that is generated in the `gen` directory) and `sqlite-jdbc-3.51.1.1.jar` for the Java project.<br>
